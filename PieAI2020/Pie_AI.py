...
TitleHTML = 'Pie & AI presentation 2020 by Jacob Barhak & Joshua Schertz'
SavedFileName = 'Presentation_PieAI_2020.html'
PublishURL = 'https://jacob-barhak.github.io/'+SavedFileName
CodePublishURL = 'https://github.com/Jacob-Barhak/Presentations/tree/master/PieAI'
QRCodeFileName = 'PieAI_2020.png'
...
PresentationTitle = panel.panel('# Clinical Unit Mapping AI', width=820, height=50, margin = (0,0,0,0))
PresentationVenueText = panel.panel('Pie & AI - 28 March 2020', width=170, height=20, margin = (0,0,0,0))
PresentationVenueFigure = panel.panel(ConstractImageLinkAnchor('https://www.meetup.com/Austin-Deep-Learning/events/268241786/','PieAI_Logo.png','Pie % AI',150), width=150, height=30, margin = (0,0,0,0))
...
Clinical trials are now reported in a NIH/NLM governed registry [ClinicalTrials.Gov](https://clinicaltrials.gov) according to [U.S. law](https://www.gpo.gov/fdsys/pkg/PLAW-110publ85/pdf/PLAW-110publ85.pdf#page=82) that requires registration of clinical trial data. 

However, despite the great effort by the government to centralize the data, the reporting entities do not follow a standard when entering data. 
...
Currently this project is focused on unit comprehension, yet those ideas can be extended so that medical data can eventually become machine comprehensible. 

Difficulties and solutions will be discussed.

""", width=700, height=500)


Section0 = Section0AbstractText
...
## <span style="color:red">HoloViz proved very useful for monitoring machine learning.</span>
