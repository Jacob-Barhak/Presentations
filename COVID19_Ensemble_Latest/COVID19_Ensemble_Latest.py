...
The Reference Model has therefore reached the achievement of being the first known multi-scale ensemble model for COVID-19. This project is ongoing and this presentation is constantly updated for each venue. 

This presentation is constantly updated to access the most recent publication please use this link[https://jacob-barhak.github.io/COVID19_Ensemble_Latest.html](https://jacob-barhak.github.io/COVID19_Ensemble_Latest.html)
...
The results presented here was executed on 64 core server for almost 3 weeks - this roughly means roughly 3.5 years of computation on a single CPU core.  The Interactive plot below summarize the results:
...
The interesting element in this simulation are:

* Preference of a lengthy infectiousness profile. 
* Reduction of influence of transmission models that depend on temperature.
* Preference of the Castiglione mortality model based on cell and organ failure that deals with mortality time.
* Slight preference of the Apple Mobility based models as behavior estimator.
* No preference of any observer model
...
***If this plot was available in May 2022, the DHS could have had infectiousness information at hand*** 
"""), width=Width, height=None)
...
* The phenomena itself is random and has large variability, even between states, and human behavior patterns were different.
...
* Future work includes expanding the model to different periods and different model fitness definitions. 

### Reproducibility:
Results presented in this work are archived in the file MIST_Ref_COVID19_Large_2022_10_22.zip for reproducibility purposes. MIST version 0.99.7.8 and python 2.7.18 with the Anaconda distribution were used for executing the simulation.
Visualization processing is archived in: ExplorationCOVID19_2022_10_23_100K_1Apr_21Dx10x48.zip. 
...
Previous published versions of this presentation are archived [here](https://github.com/Jacob-Barhak/Presentations/commits/master/COVID19_Ensemble_Latest)

"""%(PublishURL,CodePublishURL)), width=700, height=None)
