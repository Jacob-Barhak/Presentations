...
TitleHTML = 'Galvanize Austin Data Science presentation 2020 by Jacob Barhak & Joshua Schertz'
SavedFileName = 'Presentation_Galvanize_Austin_2019_01.html'
PublishURL = 'https://jacob-barhak.github.io/'+SavedFileName
CodePublishURL = 'https://github.com/Jacob-Barhak/Presentations/tree/master/Galvanize_2020_01'
QRCodeFileName = 'Galvanize_DataScience_2020_01.png'
...
PresentationTitle = panel.panel('# Visualizing Machine Learning for Healthcare using HoloViz', width=820, height=50, margin = (0,0,0,0))
PresentationVenueText = panel.panel('Galvanize 28 Jan 2020', width=170, height=20, margin = (0,0,0,0))
PresentationVenueFigure = panel.panel(ConstractImageLinkAnchor('https://www.galvanize.com/','galvanize-logo-transparent.png','Galvanize',150), width=150, height=30, margin = (0,0,0,0))
